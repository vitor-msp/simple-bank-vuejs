...
if (!API_URL || API_URL.localeCompare('') === 0) throw Error('missing API_URL environment variable')
...
export const inactivateAccountUsecase = new InactivateAccountUsecase(httpAdapter)
